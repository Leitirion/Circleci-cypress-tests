...
3. Run test on your local machine with command ```npm run cy:run```. (Also you can open cypress menu with npm run cy:open then use which test you need and run it.)
